bash run_script.sh \
    ...
    --save_path /Group16T/common/ccuc/Mywork/result/immune/ \
    --batch_key batch \
...
bash run_script.sh \
    ...
    --save_path /Group16T/common/ccuc/Mywork/result/lung/ \
    --batch_key batch \
...
bash run_script.sh \
    ...
    --save_path /Group16T/common/ccuc/Mywork/result/pancreas/ \
    --batch_key tech \
